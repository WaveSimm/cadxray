...
<sub>Every screen above is a real run on FreeCAD 1.1.3 — the numbers are the ones the tools reported. Walk through them yourself in the [eleven hands-on exercises](https://wavesimm.github.io/cadxray/en/practice/01-plate-holes/).</sub>

> **Hands-on guide site**: https://wavesimm.github.io/cadxray/en/ — install, what it can do, eleven exercises (from drilling four holes in a plate to redrawing STEP and STL, 2D drawings, print review and structural analysis), and how to write prompts. The exercise files are in [Release practice-files-v1](https://github.com/WaveSimm/cadxray/releases/tag/practice-files-v1).
