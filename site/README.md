...
https://wavesimm.github.io/cadxray/ — AI 코딩 툴과 cadxray 로 FreeCAD 1.1.3 에서 3D 모델을 말로 만드는 법(설치·할 수 있는 것·실습 11개·프롬프트 작성법). 영문판은 [/en/](https://wavesimm.github.io/cadxray/en/) — 한국어가 기본 로케일이고 영문은 `src/content/docs/en/` 아래 같은 구조로 둔다.
